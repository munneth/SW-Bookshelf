...
export const config = {
  ...
  dark: vars({
    ...
    '--color-outline-100': '220 220 220',
    '--color-outline-200': '200 200 200',
    '--color-outline-300': '180 180 180',
    ...
    /* Background - Black focused */
    '--color-background-0': '0 0 0',
    '--color-background-50': '10 10 10',
    '--color-background-100': '20 20 20',
    '--color-background-200': '30 30 30',
    '--color-background-300': '40 40 40',
    '--color-background-400': '50 50 50',
    '--color-background-500': '60 60 60',
    '--color-background-600': '70 70 70',
    '--color-background-700': '80 80 80',
    '--color-background-800': '90 90 90',
    '--color-background-900': '100 100 100',
    '--color-background-950': '110 110 110',
